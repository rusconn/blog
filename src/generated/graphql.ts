...
export type ScheduledOperationAffectedDocument = Asset | Post | Tag;
...
export type PostQuery = { post?: { id: string, slug: string, title: string, date: string, body: { html: string }, tags: Array<{ id: string, slug: string, name: string }> } | null | undefined };
...
export type TagQuery = { tag?: { id: string, slug: string, name: string, posts: Array<{ id: string, slug: string, title: string, date: string }> } | null | undefined };
...
export const PostExistenceDocument = gql`
  ...
  post(where: {slug: $slug}, stage: DRAFT) {
    ...
    `;
export type PostExistenceQueryResult = ApolloReactCommon.QueryResult<PostExistenceQuery, PostExistenceQueryVariables>;
...
export const PostPathsDocument = gql`
  ...
  posts {
    ...
    `;
export type PostPathsQueryResult = ApolloReactCommon.QueryResult<PostPathsQuery, PostPathsQueryVariables>;
...
export const TagPathsDocument = gql`
  ...
  tags {
    ...
    `;
export type TagPathsQueryResult = ApolloReactCommon.QueryResult<TagPathsQuery, TagPathsQueryVariables>;